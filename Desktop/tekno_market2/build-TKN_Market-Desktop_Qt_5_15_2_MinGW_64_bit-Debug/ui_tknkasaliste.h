/********************************************************************************
** Form generated from reading UI file 'tknkasaliste.ui'
**
...
#ifndef UI_TKNKASALISTE_H
#define UI_TKNKASALISTE_H
...
public:
    ...
    void setupUi(QDialog *TKNKasaListe)
    {
        ...
        tableWidget = new QTableWidget(TKNKasaListe);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));

        verticalLayout_4->addWidget(tableWidget);

        pushButton_2 = new QPushButton(TKNKasaListe);
        ...
        retranslateUi(TKNKasaListe);
        QObject::connect(cbYazarkenAra, SIGNAL(clicked(bool)), pushButton, SLOT(setDisabled(bool)));
        QObject::connect(leParcaModelDegeri, SIGNAL(textChanged(QString)), TKNKasaListe, SLOT(Ara()));
        QObject::connect(leParcaMarkaDegeri, SIGNAL(textChanged(QString)), TKNKasaListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIceren, SIGNAL(clicked()), TKNKasaListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBiten, SIGNAL(clicked()), TKNKasaListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBaslayan, SIGNAL(clicked()), TKNKasaListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIceren, SIGNAL(clicked()), TKNKasaListe, SLOT(Ara()));
    ...
    void retranslateUi(QDialog *TKNKasaListe)
    {
        TKNKasaListe->setWindowTitle(QCoreApplication::translate("TKNKasaListe", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("TKNKasaListe", "Arama", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("TKNKasaListe", "Par\303\247a Markas\304\261", nullptr));
        label->setText(QCoreApplication::translate("TKNKasaListe", "De\304\237er", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("TKNKasaListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaMarkaIleBaslayan->setText(QCoreApplication::translate("TKNKasaListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaMarkaIleBiten->setText(QCoreApplication::translate("TKNKasaListe", "\304\260le Biten", nullptr));
        rbParcaMarkaIceren->setText(QCoreApplication::translate("TKNKasaListe", "\304\260\303\247eren", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("TKNKasaListe", "Par\303\247a Modeli", nullptr));
        label_2->setText(QCoreApplication::translate("TKNKasaListe", "De\304\237er", nullptr));
        groupBox_5->setTitle(QCoreApplication::translate("TKNKasaListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaModelIleBaslayan->setText(QCoreApplication::translate("TKNKasaListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaModelIleBiten->setText(QCoreApplication::translate("TKNKasaListe", "\304\260le Biten", nullptr));
        rbParcaModelIceren->setText(QCoreApplication::translate("TKNKasaListe", "\304\260\303\247eren", nullptr));
        pushButton->setText(QCoreApplication::translate("TKNKasaListe", "Ara", nullptr));
        cbYazarkenAra->setText(QCoreApplication::translate("TKNKasaListe", "Yazarken Ara", nullptr));
        pushButton_2->setText(QCoreApplication::translate("TKNKasaListe", "Kapat", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TKNKasaListe: public Ui_TKNKasaListe {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TKNKASALISTE_H
