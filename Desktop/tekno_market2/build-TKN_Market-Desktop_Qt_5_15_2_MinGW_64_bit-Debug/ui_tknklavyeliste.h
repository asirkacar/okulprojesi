/********************************************************************************
** Form generated from reading UI file 'tknklavyeliste.ui'
**
...
#ifndef UI_TKNKLAVYELISTE_H
#define UI_TKNKLAVYELISTE_H
...
public:
    ...
    void setupUi(QDialog *TKNKlavyeListe)
    {
        if (TKNKlavyeListe->objectName().isEmpty())
            TKNKlavyeListe->setObjectName(QString::fromUtf8("TKNKlavyeListe"));
        TKNKlavyeListe->resize(755, 531);
        TKNKlavyeListe->setStyleSheet(QString::fromUtf8("/*\n"
...
"	background-color: #ffffff;\n"
"}"));
        verticalLayout_4 = new QVBoxLayout(TKNKlavyeListe);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        groupBox = new QGroupBox(TKNKlavyeListe);
        ...
        tableWidget = new QTableWidget(TKNKlavyeListe);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));

        verticalLayout_4->addWidget(tableWidget);

        pushButton_2 = new QPushButton(TKNKlavyeListe);
        ...
        retranslateUi(TKNKlavyeListe);
        QObject::connect(cbYazarkenAra, SIGNAL(clicked(bool)), pushButton, SLOT(setDisabled(bool)));
        QObject::connect(leParcaModelDegeri, SIGNAL(textChanged(QString)), TKNKlavyeListe, SLOT(Ara()));
        QObject::connect(leParcaMarkaDegeri, SIGNAL(textChanged(QString)), TKNKlavyeListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIceren, SIGNAL(clicked()), TKNKlavyeListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBiten, SIGNAL(clicked()), TKNKlavyeListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBaslayan, SIGNAL(clicked()), TKNKlavyeListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIceren, SIGNAL(clicked()), TKNKlavyeListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBiten, SIGNAL(clicked()), TKNKlavyeListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBaslayan, SIGNAL(clicked()), TKNKlavyeListe, SLOT(Ara()));
        QObject::connect(pushButton_2, SIGNAL(clicked()), TKNKlavyeListe, SLOT(accept()));
        QObject::connect(pushButton, SIGNAL(clicked()), TKNKlavyeListe, SLOT(Ara()));

        QMetaObject::connectSlotsByName(TKNKlavyeListe);
    } // setupUi

    void retranslateUi(QDialog *TKNKlavyeListe)
    {
        TKNKlavyeListe->setWindowTitle(QCoreApplication::translate("TKNKlavyeListe", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("TKNKlavyeListe", "Arama", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("TKNKlavyeListe", "Par\303\247a Markas\304\261", nullptr));
        label->setText(QCoreApplication::translate("TKNKlavyeListe", "De\304\237er", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("TKNKlavyeListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaMarkaIleBaslayan->setText(QCoreApplication::translate("TKNKlavyeListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaMarkaIleBiten->setText(QCoreApplication::translate("TKNKlavyeListe", "\304\260le Biten", nullptr));
        rbParcaMarkaIceren->setText(QCoreApplication::translate("TKNKlavyeListe", "\304\260\303\247eren", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("TKNKlavyeListe", "Par\303\247a Modeli", nullptr));
        label_2->setText(QCoreApplication::translate("TKNKlavyeListe", "De\304\237er", nullptr));
        groupBox_5->setTitle(QCoreApplication::translate("TKNKlavyeListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaModelIleBaslayan->setText(QCoreApplication::translate("TKNKlavyeListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaModelIleBiten->setText(QCoreApplication::translate("TKNKlavyeListe", "\304\260le Biten", nullptr));
        rbParcaModelIceren->setText(QCoreApplication::translate("TKNKlavyeListe", "\304\260\303\247eren", nullptr));
        pushButton->setText(QCoreApplication::translate("TKNKlavyeListe", "Ara", nullptr));
        cbYazarkenAra->setText(QCoreApplication::translate("TKNKlavyeListe", "Yazarken Ara", nullptr));
        pushButton_2->setText(QCoreApplication::translate("TKNKlavyeListe", "Kapat", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TKNKlavyeListe: public Ui_TKNKlavyeListe {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TKNKLAVYELISTE_H
