/********************************************************************************
** Form generated from reading UI file 'tknharddiskliste.ui'
**
...
#ifndef UI_TKNHARDDISKLISTE_H
#define UI_TKNHARDDISKLISTE_H
...
public:
    ...
    void setupUi(QDialog *TKNHarddiskListe)
    {
        if (TKNHarddiskListe->objectName().isEmpty())
            TKNHarddiskListe->setObjectName(QString::fromUtf8("TKNHarddiskListe"));
        TKNHarddiskListe->resize(755, 565);
        TKNHarddiskListe->setStyleSheet(QString::fromUtf8("/*\n"
...
"	background-color: #ffffff;\n"
"}"));
        verticalLayout_4 = new QVBoxLayout(TKNHarddiskListe);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        groupBox = new QGroupBox(TKNHarddiskListe);
        ...
        tableWidget = new QTableWidget(TKNHarddiskListe);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));

        verticalLayout_4->addWidget(tableWidget);

        pushButton_2 = new QPushButton(TKNHarddiskListe);
        ...
        retranslateUi(TKNHarddiskListe);
        QObject::connect(cbYazarkenAra, SIGNAL(clicked(bool)), pushButton, SLOT(setDisabled(bool)));
        QObject::connect(leParcaModelDegeri, SIGNAL(textChanged(QString)), TKNHarddiskListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIceren, SIGNAL(clicked()), TKNHarddiskListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBiten, SIGNAL(clicked()), TKNHarddiskListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBaslayan, SIGNAL(clicked()), TKNHarddiskListe, SLOT(Ara()));
        QObject::connect(leParcaMarkaDegeri, SIGNAL(textChanged(QString)), TKNHarddiskListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIceren, SIGNAL(clicked()), TKNHarddiskListe, SLOT(Ara()));
    ...
    void retranslateUi(QDialog *TKNHarddiskListe)
    {
        TKNHarddiskListe->setWindowTitle(QCoreApplication::translate("TKNHarddiskListe", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("TKNHarddiskListe", "Arama", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("TKNHarddiskListe", "Par\303\247a Markas\304\261", nullptr));
        label->setText(QCoreApplication::translate("TKNHarddiskListe", "De\304\237er", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("TKNHarddiskListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaMarkaIleBaslayan->setText(QCoreApplication::translate("TKNHarddiskListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaMarkaIleBiten->setText(QCoreApplication::translate("TKNHarddiskListe", "\304\260le Biten", nullptr));
        rbParcaMarkaIceren->setText(QCoreApplication::translate("TKNHarddiskListe", "\304\260\303\247eren", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("TKNHarddiskListe", "Par\303\247a Modeli", nullptr));
        label_2->setText(QCoreApplication::translate("TKNHarddiskListe", "De\304\237er", nullptr));
        groupBox_5->setTitle(QCoreApplication::translate("TKNHarddiskListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaModelIleBaslayan->setText(QCoreApplication::translate("TKNHarddiskListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaModelIleBiten->setText(QCoreApplication::translate("TKNHarddiskListe", "\304\260le Biten", nullptr));
        rbParcaModelIceren->setText(QCoreApplication::translate("TKNHarddiskListe", "\304\260\303\247eren", nullptr));
        pushButton->setText(QCoreApplication::translate("TKNHarddiskListe", "Ara", nullptr));
        cbYazarkenAra->setText(QCoreApplication::translate("TKNHarddiskListe", "Yazarken Ara", nullptr));
        pushButton_2->setText(QCoreApplication::translate("TKNHarddiskListe", "Kapat", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TKNHarddiskListe: public Ui_TKNHarddiskListe {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TKNHARDDISKLISTE_H
