/********************************************************************************
** Form generated from reading UI file 'tknislemciliste.ui'
**
...
#ifndef UI_TKNISLEMCILISTE_H
#define UI_TKNISLEMCILISTE_H
...
public:
    ...
    void setupUi(QDialog *TKNIslemciListe)
    {
        if (TKNIslemciListe->objectName().isEmpty())
            TKNIslemciListe->setObjectName(QString::fromUtf8("TKNIslemciListe"));
        TKNIslemciListe->resize(755, 583);
        TKNIslemciListe->setStyleSheet(QString::fromUtf8("/*\n"
...
"	background-color: #ffffff;\n"
"}"));
        verticalLayout_4 = new QVBoxLayout(TKNIslemciListe);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        groupBox = new QGroupBox(TKNIslemciListe);
        ...
        tableWidget = new QTableWidget(TKNIslemciListe);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));

        verticalLayout_4->addWidget(tableWidget);

        pushButton_2 = new QPushButton(TKNIslemciListe);
        ...
        retranslateUi(TKNIslemciListe);
        QObject::connect(cbYazarkenAra, SIGNAL(clicked(bool)), pushButton, SLOT(setDisabled(bool)));
        QObject::connect(leParcaModelDegeri, SIGNAL(textChanged(QString)), TKNIslemciListe, SLOT(Ara()));
        QObject::connect(leParcaMarkaDegeri, SIGNAL(textChanged(QString)), TKNIslemciListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIceren, SIGNAL(clicked()), TKNIslemciListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBiten, SIGNAL(clicked()), TKNIslemciListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBaslayan, SIGNAL(clicked()), TKNIslemciListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIceren, SIGNAL(clicked()), TKNIslemciListe, SLOT(Ara()));
    ...
    void retranslateUi(QDialog *TKNIslemciListe)
    {
        TKNIslemciListe->setWindowTitle(QCoreApplication::translate("TKNIslemciListe", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("TKNIslemciListe", "Arama", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("TKNIslemciListe", "Par\303\247a Markas\304\261", nullptr));
        label->setText(QCoreApplication::translate("TKNIslemciListe", "De\304\237er", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("TKNIslemciListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaMarkaIleBaslayan->setText(QCoreApplication::translate("TKNIslemciListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaMarkaIleBiten->setText(QCoreApplication::translate("TKNIslemciListe", "\304\260le Biten", nullptr));
        rbParcaMarkaIceren->setText(QCoreApplication::translate("TKNIslemciListe", "\304\260\303\247eren", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("TKNIslemciListe", "Par\303\247a Modeli", nullptr));
        label_2->setText(QCoreApplication::translate("TKNIslemciListe", "De\304\237er", nullptr));
        groupBox_5->setTitle(QCoreApplication::translate("TKNIslemciListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaModelIleBaslayan->setText(QCoreApplication::translate("TKNIslemciListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaModelIleBiten->setText(QCoreApplication::translate("TKNIslemciListe", "\304\260le Biten", nullptr));
        rbParcaModelIceren->setText(QCoreApplication::translate("TKNIslemciListe", "\304\260\303\247eren", nullptr));
        pushButton->setText(QCoreApplication::translate("TKNIslemciListe", "Ara", nullptr));
        cbYazarkenAra->setText(QCoreApplication::translate("TKNIslemciListe", "Yazarken Ara", nullptr));
        pushButton_2->setText(QCoreApplication::translate("TKNIslemciListe", "Kapat", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TKNIslemciListe: public Ui_TKNIslemciListe {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TKNISLEMCILISTE_H
