/********************************************************************************
** Form generated from reading UI file 'tknguckaynakliste.ui'
**
...
#ifndef UI_TKNGUCKAYNAKLISTE_H
#define UI_TKNGUCKAYNAKLISTE_H
...
public:
    ...
    void setupUi(QDialog *TKNGucKaynakListe)
    {
        if (TKNGucKaynakListe->objectName().isEmpty())
            TKNGucKaynakListe->setObjectName(QString::fromUtf8("TKNGucKaynakListe"));
        TKNGucKaynakListe->resize(812, 578);
        TKNGucKaynakListe->setStyleSheet(QString::fromUtf8("/*\n"
...
"	background-color: #ffffff;\n"
"}"));
        verticalLayout_4 = new QVBoxLayout(TKNGucKaynakListe);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        groupBox = new QGroupBox(TKNGucKaynakListe);
        ...
        tableWidget = new QTableWidget(TKNGucKaynakListe);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));

        verticalLayout_4->addWidget(tableWidget);

        pushButton_2 = new QPushButton(TKNGucKaynakListe);
        ...
        retranslateUi(TKNGucKaynakListe);
        QObject::connect(cbYazarkenAra, SIGNAL(clicked(bool)), pushButton, SLOT(setDisabled(bool)));
        QObject::connect(leParcaModelDegeri, SIGNAL(textChanged(QString)), TKNGucKaynakListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIceren, SIGNAL(clicked()), TKNGucKaynakListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBiten, SIGNAL(clicked()), TKNGucKaynakListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBaslayan, SIGNAL(clicked()), TKNGucKaynakListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIceren, SIGNAL(clicked()), TKNGucKaynakListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBiten, SIGNAL(clicked()), TKNGucKaynakListe, SLOT(Ara()));
    ...
    void retranslateUi(QDialog *TKNGucKaynakListe)
    {
        TKNGucKaynakListe->setWindowTitle(QCoreApplication::translate("TKNGucKaynakListe", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("TKNGucKaynakListe", "Arama", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("TKNGucKaynakListe", "Par\303\247a Markas\304\261", nullptr));
        label->setText(QCoreApplication::translate("TKNGucKaynakListe", "De\304\237er", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("TKNGucKaynakListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaMarkaIleBaslayan->setText(QCoreApplication::translate("TKNGucKaynakListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaMarkaIleBiten->setText(QCoreApplication::translate("TKNGucKaynakListe", "\304\260le Biten", nullptr));
        rbParcaMarkaIceren->setText(QCoreApplication::translate("TKNGucKaynakListe", "\304\260\303\247eren", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("TKNGucKaynakListe", "Par\303\247a Modeli", nullptr));
        label_2->setText(QCoreApplication::translate("TKNGucKaynakListe", "De\304\237er", nullptr));
        groupBox_5->setTitle(QCoreApplication::translate("TKNGucKaynakListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaModelIleBaslayan->setText(QCoreApplication::translate("TKNGucKaynakListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaModelIleBiten->setText(QCoreApplication::translate("TKNGucKaynakListe", "\304\260le Biten", nullptr));
        rbParcaModelIceren->setText(QCoreApplication::translate("TKNGucKaynakListe", "\304\260\303\247eren", nullptr));
        pushButton->setText(QCoreApplication::translate("TKNGucKaynakListe", "Ara", nullptr));
        cbYazarkenAra->setText(QCoreApplication::translate("TKNGucKaynakListe", "Yazarken Ara", nullptr));
        pushButton_2->setText(QCoreApplication::translate("TKNGucKaynakListe", "Kapat", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TKNGucKaynakListe: public Ui_TKNGucKaynakListe {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TKNGUCKAYNAKLISTE_H
