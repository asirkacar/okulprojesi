/********************************************************************************
** Form generated from reading UI file 'tknramliste.ui'
**
...
#ifndef UI_TKNRAMLISTE_H
#define UI_TKNRAMLISTE_H
...
public:
    ...
    void setupUi(QDialog *TKNRamListe)
    {
        if (TKNRamListe->objectName().isEmpty())
            TKNRamListe->setObjectName(QString::fromUtf8("TKNRamListe"));
        TKNRamListe->resize(755, 459);
        TKNRamListe->setStyleSheet(QString::fromUtf8("/*\n"
...
"	background-color: #ffffff;\n"
"}"));
        verticalLayout_4 = new QVBoxLayout(TKNRamListe);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        groupBox = new QGroupBox(TKNRamListe);
        ...
        tableWidget = new QTableWidget(TKNRamListe);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));

        verticalLayout_4->addWidget(tableWidget);

        pushButton_2 = new QPushButton(TKNRamListe);
        ...
        retranslateUi(TKNRamListe);
        QObject::connect(cbYazarkenAra, SIGNAL(clicked(bool)), pushButton, SLOT(setDisabled(bool)));
        QObject::connect(leParcaModelDegeri, SIGNAL(textChanged(QString)), TKNRamListe, SLOT(Ara()));
        QObject::connect(leParcaMarkaDegeri, SIGNAL(textChanged(QString)), TKNRamListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIceren, SIGNAL(clicked()), TKNRamListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBiten, SIGNAL(clicked()), TKNRamListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBaslayan, SIGNAL(clicked()), TKNRamListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIceren, SIGNAL(clicked()), TKNRamListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBiten, SIGNAL(clicked()), TKNRamListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBaslayan, SIGNAL(clicked()), TKNRamListe, SLOT(Ara()));
        QObject::connect(pushButton_2, SIGNAL(clicked()), TKNRamListe, SLOT(accept()));
        QObject::connect(pushButton, SIGNAL(clicked()), TKNRamListe, SLOT(Ara()));

        QMetaObject::connectSlotsByName(TKNRamListe);
    } // setupUi

    void retranslateUi(QDialog *TKNRamListe)
    {
        TKNRamListe->setWindowTitle(QCoreApplication::translate("TKNRamListe", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("TKNRamListe", "Arama", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("TKNRamListe", "Par\303\247a Markas\304\261", nullptr));
        label->setText(QCoreApplication::translate("TKNRamListe", "De\304\237er", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("TKNRamListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaMarkaIleBaslayan->setText(QCoreApplication::translate("TKNRamListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaMarkaIleBiten->setText(QCoreApplication::translate("TKNRamListe", "\304\260le Biten", nullptr));
        rbParcaMarkaIceren->setText(QCoreApplication::translate("TKNRamListe", "\304\260\303\247eren", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("TKNRamListe", "Par\303\247a Modeli", nullptr));
        label_2->setText(QCoreApplication::translate("TKNRamListe", "De\304\237er", nullptr));
        groupBox_5->setTitle(QCoreApplication::translate("TKNRamListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaModelIleBaslayan->setText(QCoreApplication::translate("TKNRamListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaModelIleBiten->setText(QCoreApplication::translate("TKNRamListe", "\304\260le Biten", nullptr));
        rbParcaModelIceren->setText(QCoreApplication::translate("TKNRamListe", "\304\260\303\247eren", nullptr));
        pushButton->setText(QCoreApplication::translate("TKNRamListe", "Ara", nullptr));
        cbYazarkenAra->setText(QCoreApplication::translate("TKNRamListe", "Yazarken Ara", nullptr));
        pushButton_2->setText(QCoreApplication::translate("TKNRamListe", "Kapat", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TKNRamListe: public Ui_TKNRamListe {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TKNRAMLISTE_H
