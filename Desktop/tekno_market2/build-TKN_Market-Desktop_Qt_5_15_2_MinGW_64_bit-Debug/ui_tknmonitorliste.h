/********************************************************************************
** Form generated from reading UI file 'tknmonitorliste.ui'
**
...
#ifndef UI_TKNMONITORLISTE_H
#define UI_TKNMONITORLISTE_H
...
public:
    ...
    void setupUi(QDialog *TKNMonitorListe)
    {
        if (TKNMonitorListe->objectName().isEmpty())
            TKNMonitorListe->setObjectName(QString::fromUtf8("TKNMonitorListe"));
        TKNMonitorListe->resize(785, 549);
        TKNMonitorListe->setStyleSheet(QString::fromUtf8("/*\n"
...
"	background-color: #ffffff;\n"
"}"));
        verticalLayout_4 = new QVBoxLayout(TKNMonitorListe);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        groupBox = new QGroupBox(TKNMonitorListe);
        ...
        tableWidget = new QTableWidget(TKNMonitorListe);
        tableWidget->setObjectName(QString::fromUtf8("tableWidget"));

        verticalLayout_4->addWidget(tableWidget);

        pushButton_2 = new QPushButton(TKNMonitorListe);
        ...
        retranslateUi(TKNMonitorListe);
        QObject::connect(cbYazarkenAra, SIGNAL(clicked(bool)), pushButton, SLOT(setDisabled(bool)));
        QObject::connect(leParcaModelDegeri, SIGNAL(textChanged(QString)), TKNMonitorListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIceren, SIGNAL(clicked()), TKNMonitorListe, SLOT(Ara()));
        QObject::connect(leParcaMarkaDegeri, SIGNAL(textChanged(QString)), TKNMonitorListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIceren, SIGNAL(clicked()), TKNMonitorListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBiten, SIGNAL(clicked()), TKNMonitorListe, SLOT(Ara()));
        QObject::connect(rbParcaMarkaIleBaslayan, SIGNAL(clicked()), TKNMonitorListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBiten, SIGNAL(clicked()), TKNMonitorListe, SLOT(Ara()));
        QObject::connect(rbParcaModelIleBaslayan, SIGNAL(clicked()), TKNMonitorListe, SLOT(Ara()));
        QObject::connect(pushButton_2, SIGNAL(clicked()), TKNMonitorListe, SLOT(accept()));
        QObject::connect(pushButton, SIGNAL(clicked()), TKNMonitorListe, SLOT(Ara()));

        QMetaObject::connectSlotsByName(TKNMonitorListe);
    } // setupUi

    void retranslateUi(QDialog *TKNMonitorListe)
    {
        TKNMonitorListe->setWindowTitle(QCoreApplication::translate("TKNMonitorListe", "Dialog", nullptr));
        groupBox->setTitle(QCoreApplication::translate("TKNMonitorListe", "Arama", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("TKNMonitorListe", "Par\303\247a Markas\304\261", nullptr));
        label->setText(QCoreApplication::translate("TKNMonitorListe", "De\304\237er", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("TKNMonitorListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaMarkaIleBaslayan->setText(QCoreApplication::translate("TKNMonitorListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaMarkaIleBiten->setText(QCoreApplication::translate("TKNMonitorListe", "\304\260le Biten", nullptr));
        rbParcaMarkaIceren->setText(QCoreApplication::translate("TKNMonitorListe", "\304\260\303\247eren", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("TKNMonitorListe", "Par\303\247a Modeli", nullptr));
        label_2->setText(QCoreApplication::translate("TKNMonitorListe", "De\304\237er", nullptr));
        groupBox_5->setTitle(QCoreApplication::translate("TKNMonitorListe", "Filtre T\303\274r\303\274", nullptr));
        rbParcaModelIleBaslayan->setText(QCoreApplication::translate("TKNMonitorListe", "\304\260le Ba\305\237layan", nullptr));
        rbParcaModelIleBiten->setText(QCoreApplication::translate("TKNMonitorListe", "\304\260le Biten", nullptr));
        rbParcaModelIceren->setText(QCoreApplication::translate("TKNMonitorListe", "\304\260\303\247eren", nullptr));
        pushButton->setText(QCoreApplication::translate("TKNMonitorListe", "Ara", nullptr));
        cbYazarkenAra->setText(QCoreApplication::translate("TKNMonitorListe", "Yazarken Ara", nullptr));
        pushButton_2->setText(QCoreApplication::translate("TKNMonitorListe", "Kapat", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TKNMonitorListe: public Ui_TKNMonitorListe {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TKNMONITORLISTE_H
